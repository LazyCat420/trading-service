...
def _market_closes(ticker: str) -> list[tuple]:
    """The SAME single-vendor SPY series the HMM was fitted on."""
...
def _next_return_pct(closes: list[tuple], after_date) -> float | None:
...
def _load_posteriors(ticker: str) -> list[dict]:
    from app.db.connection import get_db
