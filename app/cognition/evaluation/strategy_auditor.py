...
async def evaluate_strategy(
    ...
    try:
        ...
        # Save to database
        mongo_store.insert_docs('strategy_evaluations', [{'id': eval_id, 'cycle_id': latest_cycle_id, 'total_score': total_score, 'risk_score': risk_score, 'performance_score': perf_score, 'robustness_score': rob_score, 'logic_score': log_score, 'operational_score': op_score, 'full_analysis': payload, 'timestamp': datetime.datetime.now(datetime.timezone.utc)}])
