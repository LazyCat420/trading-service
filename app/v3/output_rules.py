...
#: A retry was refused because the run's wall clock could not fit another
#: attempt (see base_agent.RETRY_MIN_BUDGET_S). ABT, cycle-v3-1788660665.
RETRY_BUDGET_EXHAUSTED = "RETRY_BUDGET_EXHAUSTED"

RUNNER_REASONS = frozenset({SCHEMA_INVALID, TIMEOUT, CANCELLED, RUNNER_EXCEPTION, RETRY_BUDGET_EXHAUSTED})
