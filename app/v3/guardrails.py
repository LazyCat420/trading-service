...
# ═══════════════════════════════════════════════════════════════════════════
# 2. Tool Loop Detector — Catches agents calling the same tool repeatedly
# ═══════════════════════════════════════════════════════════════════════════
...
class ToolLoopDetector:
    ...
    def record_call(
        ...
        Args:
            ...
            failed: Whether the call failed/returned empty.
    ...
    def unique_failures(self) -> int:
        return sum(
            1 for k, v in self._history.items()
            if k.endswith(":failed") and v > 0
        )
