...
EXTRA_SSH_SYNC() {
  ...
  ssh "$DEPLOY_SSH_HOST" "echo 'V2_TICKER_CONCURRENCY=1' >> '${DEPLOY_COMPOSE_DIR}/.env'"
  ssh "$DEPLOY_SSH_HOST" "echo 'ADAPTIVE_MIN_CONCURRENCY=1' >> '${DEPLOY_COMPOSE_DIR}/.env'"
  ssh "$DEPLOY_SSH_HOST" "echo 'ADAPTIVE_MAX_CONCURRENCY=1' >> '${DEPLOY_COMPOSE_DIR}/.env'"
